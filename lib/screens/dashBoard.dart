...
class _DashboardState extends State<Dashboard> {
  ...
  Future<void> fetchRecommendedCourses() async {
    print('Called fetchRecommendedCourses');
    setState(() {
    ...
    if (response.statusCode == 200) {
      ...
      print("Exception catched in fetchRecommendedCourses");
      print(e.toString());
      setState(() {
        isFetchingRecommendations = false;
      });
                      ...
                      decoration: const InputDecoration(
                        ...
                        focusedBorder: OutlineInputBorder(
                          borderSide: BorderSide(
                              color: Colors.black,
                              width:
                                  2.0), // Specify the border color and width when focused
                        ),
                      ...
                      if (snapshot.connectionState == ConnectionState.waiting) {
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                ...
                                color: Colors.black.withOpacity(
                                    0.8), // Make the text more vibrant
                              ),
                            ),
                            Container(
                              padding: const EdgeInsets.all(15),
                        ...
                        return Column(
                          children: [
                            ...
                            const SizedBox(
                              height:
                                  20, // Add some spacing between "See More" and "Related Courses"
                            ),
                            Align(
