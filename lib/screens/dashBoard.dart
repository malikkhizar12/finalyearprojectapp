...
import '../core/collections.dart';
  ...
  List<String> recommendedCoursePlatform = [];
    ...
    String limitTitle(String text, int maxWords) {
      ...
      return words.take(maxWords).join(' ') + (words.length > maxWords ? ' ...' : '');
    }
        ...
        bottomNavigationBar: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [Color(0xFF6FB1FF), Color(0xFFFF9AA2)], // Blue to Red gradient
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  IconButton(
                                    icon: Icon(Icons.feedback), // Replace with your desired icon
                                    onPressed: () {
...
// Check if the URL can be launched
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: Colors.lightBlueAccent.withOpacity(0.2),  // Replace with your desired color
                              borderRadius: BorderRadius.circular(15.0),
                            ),
                ...
                Stack(
                  children: [
                    Positioned(
                      top: screenHeight * 0.2, // Adjust this value based on your design
                            ...
                            if (!snapshot.hasData) {
                              return Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text('user@example.com', style: TextStyle(color: Colors.black)),
                                  ],
                                ),
                              );
                            } else {
                              ...
                              return Row(
                                children: [
                                  ...
                                  const SizedBox(width: 15), // Add some space between the image and text
                                  Expanded(
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            (data['displayName'] ?? 'Username').toUpperCase(), // Uppercase modification
                                            style: TextStyle(
                                              color: Colors.black,
                                              fontWeight: FontWeight.w700, // Bold modification
                                            ),
                                          ),
                                          Text(data['email'] ?? 'user@example.com',
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                          ...
                                          color: Colors.redAccent.withOpacity(0.9), // Set your desired light color
                                        ),
